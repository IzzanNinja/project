    ...
    <form method="post" id="pet_lsdetail" name="pet_lsdetail">
      <section class="content">
        <h3 style="color:red;text-align:center;background-color: powderblue;">
          Keputusan Carian Petani Untuk Disemak Bagi Tahun: 2022
        </h3>
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="text-align:center;">
                        <a href="pet_smkdetail.php?a=820620-12-5239&t=2022" target="_blank">
                          <img src="images/edit.png" alt="Semak Rekod" width="30" height="30" class="img-square">
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td colspan=2 style="text-align:right;"><b>Jumlah Pemohon (ms 1):</b></td>
                      <td>1</td>
                      <td style="text-align:right;"><b>Jumlah Dipohon (Ekar)</b></td>
                      <td>0</td>
                    </tr>
                    <tr>
                      <td colspan=2 style="text-align:right;"><b>Jumlah Keseluruhan Pemohon:</b></td>
                      <td>1</td>
                      <td style="text-align:right;"><b>Jumlah Keseluruhan Dipohon (Ekar)</b></td>
                      <td></td>
                    </tr>
                  </tbody>
                </table>
